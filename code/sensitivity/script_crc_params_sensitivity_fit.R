...
# correct for a jump in reporting in China by imputing days before and after
...
save(local,import.doy,propns.ASCF,file=paste("../results/sensitivity/sensitivity_sims_",run_num,".rda",sep=""))